...
#images.append(LFImage("I02R2", nb_img_x=15, nb_img_y=15, nb_img_depth=11, top_left=(3,3))
#images.append(LFImage("I04R3", nb_img_x=15, nb_img_y=15, nb_img_depth=11, top_left=(3,3))
